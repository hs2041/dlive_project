...
def e2o_ctrl_callback(ctrl_data):
	...
	if ctrl_data.Horn == 1:
		e2OCAN_WIPHORN.DATA[7] = 0x38
	else:
		e2OCAN_WIPHORN.DATA[7] = 0x28

#=====================================================================

def obst_alert_callback(obst_data):
	global alert_flag
	alert_flag = False
	if obst_data.data > 40:
		alert_flag = True
		e2OCAN_ACCEL.DATA[7]= ACCEL_ZERO
	else:
		alert_flag = False

	if obst_data.data > 50:
		e2OCAN_WIPHORN.DATA[7] = 0x38
	else:
		e2OCAN_WIPHORN.DATA[7] = 0x28
	...
	#print("obst_data: ", obst_data.data)
		
	e2OCAN_BRAKE.DATA[7]= (obst_data.data<<1) | 1
...
if __name__ == '__main__':
	try:
		...
		rospy.Subscriber('obst_alert', Int32, obst_alert_callback)
